...
7. إذا كانت هناك معلومة ناقصة وتغييرها يمكن أن يغير الحكم، اسأل سؤالاً واحداً فقط.
8. إذا كانت المعلومات كافية، لا تسأل سؤالاً.
9. إذا لم يوجد دعم واضح للحالة، قل حرفياً:
